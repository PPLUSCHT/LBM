...
export class Simulation extends App{
    ...
    private initCollapsedButtons(): HTMLDivElement{
      ...
      container.appendChild(this.createSVGButton("/home.svg","settings", () => this.runner.returnHome()))
      return container;
    }
    ...
    private initPanel(state: State): HTMLDivElement{
      ...
      panel.appendChild(this.createSVGButton("/close.svg", "collapse", () => this.expansionButtonHandler()))
