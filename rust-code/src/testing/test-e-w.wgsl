@group(0) @binding(0) var<storage, read_write> bad_e: array<f32>;
@group(0) @binding(1) var<storage, read_write> bad_w: array<f32>;
...
fn main(@builtin(global_invocation_id) global_invocation_id: vec3<u32>){
    ...
    output[global_invocation_id.x] = bad_w[global_invocation_id.x] - w[global_invocation_id.x];
}